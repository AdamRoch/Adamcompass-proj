-- Initial Compass schema (SQLite). Hand-rolled to match packages/db/src/schema/sqlite.ts.
-- Run `pnpm db:generate` later to replace this with auto-generated migrations.
